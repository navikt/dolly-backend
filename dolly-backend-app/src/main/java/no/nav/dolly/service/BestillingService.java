...
public class BestillingService {
    ...
    public List<Bestilling> fetchSisteBestillingerByIndeks(Integer startIndex) {
        return bestillingRepository.findLatestByIndeks(nonNull(startIndex) ? startIndex : 0).orElse(emptyList());
    }
